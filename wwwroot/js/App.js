...
function App() {
    ...
    const renderView = () => {
        ...
        switch (currentView) {
            ...
            case 'series-list':
                return <SeriesList onNavigate={handleNavigate} />;

            case 'serie-detail':
                if (!viewData || !viewData.serieId) {
                    return <div style={styles.error}>Serie no encontrada</div>;
                }
                return <SerieDetail serieId={viewData.serieId} onNavigate={handleNavigate} />;
